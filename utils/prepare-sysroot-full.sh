...
sudo losetup -P /dev/loop0 ${RASPBIAN_BASENAME}.img  # WTF  dev/loop0  /dev/loop0p2
...
sudo chroot sysroot-full /bin/bash -c "apt-get install -y libgstreamer-plugins-base1.0-0 gstreamer1.0-plugins-good"
